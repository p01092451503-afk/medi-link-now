...
export const filterOptions: { id: FilterType; label: string; labelKr: string; category: "bed" | "procedure" | "special" | "grade"; parent?: FilterType }[] = [
  ...
  { id: "moonlight", label: "Moonlight Children", labelKr: "🌙 달빛어린이병원", category: "special" },
];
...
export const regionOptions: RegionOption[] = [
  // 전국 (All regions)
  { id: "all", label: "All", labelKr: "전국", center: [36.5, 127.5], zoom: 7 },
