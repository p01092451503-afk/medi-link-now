      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-[90vw] md:max-w-2xl md:h-[80vh] bg-white rounded-2xl shadow-2xl z-[2001] flex flex-col overflow-hidden"
          >
            {/* Header */}
