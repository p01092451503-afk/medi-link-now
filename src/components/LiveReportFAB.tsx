  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-20 left-4 z-[1000] w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-colors ${
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-36 left-4 z-[1000] bg-white rounded-2xl shadow-xl border border-border p-4 min-w-[200px]"
          >
