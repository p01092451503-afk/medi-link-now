...
const StepIntro = () => (
  <div className="flex flex-col items-center text-center px-6">
    ...
    >
      <span className="text-3xl font-black text-primary-foreground tracking-tighter">ER</span>
    </motion.div>
    ...
    <motion.p
      ...
      className="text-sm text-muted-foreground leading-relaxed max-w-xs mt-3"
    >
    ...
    <motion.div
      ...
      className="grid grid-cols-2 gap-3 w-full max-w-xs mt-6"
    >
