...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/10 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-4">
        ...
        >
          ...
          <button
            ...
            className="w-full h-[64px] px-5 rounded-2xl bg-primary hover:bg-primary/90 shadow-lg shadow-primary/30 relative overflow-hidden group transition-colors"
          >
          ...
          <button
            ...
            className="w-full h-[64px] px-5 rounded-2xl border-2 border-orange-400 bg-white hover:bg-orange-50 relative overflow-hidden group transition-colors"
          >
            <div className="relative flex items-center w-full h-full">
      ...
      {/* Footer */}
      <footer className="p-3 text-center space-y-1.5">
