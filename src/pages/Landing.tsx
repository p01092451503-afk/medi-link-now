      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative w-32 h-16 flex items-end justify-center">
            ...
            <div className="absolute bottom-1 w-full h-[2px] bg-muted-foreground/20 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  backgroundImage: 'repeating-linear-gradient(90deg, hsl(var(--muted-foreground) / 0.4) 0px, hsl(var(--muted-foreground) / 0.4) 6px, transparent 6px, transparent 12px)',
                  animation: 'road-dash 0.4s linear infinite',
                }}
              />
            </div>
            {/* Ambulance SVG */}
            <div style={{ animation: 'ambulance-drive 2.5s ease-in-out infinite alternate, ambulance-bounce 0.3s ease-in-out infinite' }}>
          ...
          <p className="text-sm font-medium text-muted-foreground">
            준비 중
            <span style={{ animation: 'loading-dot 1.4s infinite', animationDelay: '0s' }}>.</span>
            <span style={{ animation: 'loading-dot 1.4s infinite', animationDelay: '0.2s' }}>.</span>
            <span style={{ animation: 'loading-dot 1.4s infinite', animationDelay: '0.4s' }}>.</span>
          </p>
        </div>
      </div>
    );
        ...
        <section className="px-5 pt-12 pb-16">
          ...
          >
            <button
              ...
              className="flex-[2.3] flex items-center justify-center gap-2 py-4 bg-foreground text-background rounded-2xl font-semibold text-[15px] hover:opacity-90 active:scale-[0.98] transition-all"
            >
              응급실 찾기
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-4 bg-secondary text-foreground rounded-2xl font-semibold text-[15px] hover:opacity-80 active:scale-[0.98] transition-all"
            >
              응급 가이드
            </button>
          </motion.div>
